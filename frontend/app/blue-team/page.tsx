...
export default function BlueTeamPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setStatus(s); setModels(m); setLoading(false)
    })
  }, [])
  ...
  // Feature importance from real detection data
  ...
  // Buffer list from real evidence data
  const bufferList = (b?.recent || []).slice(0, 8).map((e: any) => ({
    fam: e.attack_family || "unknown",
    why: e.evasion_outcome || "analysis pending",
    reason: e.sandbox_decision === "ALLOW" ? "novel failure" : e.sandbox_decision === "CHALLENGE" ? "high-information" : "baseline",
  }))

  // Compare grid from real metrics
  ...
  return (
    <div style={{ padding: "22px 28px 0" }}>
      ...
      <div style={{ marginBottom: 18 }}>
        <div style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: ".6px", color: "#6b7280", fontWeight: 500 }}>Blue Team / Hardening</div>
        <h1 style={{ margin: "4px 0 4px", fontSize: 22, fontWeight: 700 }}>Blue Team</h1>
        <p style={{ margin: 0, color: "#6b7280", fontSize: 13 }}>FraudShield -- feature engineering, scoring, adversarial buffer and the hardening pipeline.</p>
      </div>

      {/* Model Version Table */}
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: 18, marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          <div style={{ fontSize: 13, fontWeight: 600 }}>Model version history <span style={{ fontSize: 9.5, padding: "2px 7px", borderRadius: 5, background: "#f9fafb", color: "#6b7280", fontFamily: "'JetBrains Mono', monospace" }}>lineage</span></div>
          <span style={{ fontSize: 10, padding: "2px 8px", borderRadius: 100, background: "rgba(22,163,74,.12)", color: "#16a34a", fontFamily: "'JetBrains Mono', monospace" }}>active: {m?.version || "v3"}</span>
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          ...
          <tbody>
            ...
            <tr>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb" }}><span style={{ padding: "2px 9px", borderRadius: 5, fontSize: 10.5, fontWeight: 700, background: "#f3f4f6" }}>v2</span></td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb" }}>v1 + adversarial examples</td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb", fontFamily: "'JetBrains Mono', monospace" }}>--</td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb", fontFamily: "'JetBrains Mono', monospace" }}>--</td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb", fontFamily: "'JetBrains Mono', monospace" }}>--</td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb", fontFamily: "'JetBrains Mono', monospace" }}>--</td>
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb", fontFamily: "'JetBrains Mono', monospace" }}>--</td>
            ...
            <tr style={{ background: "rgba(22,163,74,0.03)" }}>
              ...
              <td style={{ padding: "11px 10px", borderBottom: "1px solid #e5e7eb" }}>v2 + 4,812 adv. examples</td>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
        <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: 18 }}>
          <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 14 }}>Feature importance <span style={{ fontSize: 9.5, padding: "2px 7px", borderRadius: 5, background: "#f9fafb", color: "#6b7280", fontFamily: "'JetBrains Mono', monospace" }}>FraudShield {m?.version || "v3"}</span></div>
        ...
        <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: 18 }}>
          <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 14 }}>Adversarial buffer <span style={{ fontSize: 9.5, padding: "2px 7px", borderRadius: 5, background: "#f9fafb", color: "#6b7280", fontFamily: "'JetBrains Mono', monospace" }}>{b?.payment_records || 0} examples</span></div>
      ...
      {/* Compare Grid - real metrics */}
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: 18, marginBottom: 16 }}>
        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 14 }}>Before / after hardening <span style={{ fontSize: 9.5, padding: "2px 7px", borderRadius: 5, background: "#f9fafb", color: "#6b7280", fontFamily: "'JetBrains Mono', monospace" }}>v1 to v3</span></div>

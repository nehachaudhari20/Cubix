...
class JailbreakPlanner:
    ...
    def _crescendo_plan(self, family: Dict[str, Any]) -> AttackPlan:
        ...
        return AttackPlan(
            ...
            reasoning="Crescendo: device -> auth -> low pay -> high pay",
        )
    ...
    def _tree_plans(self, family: Dict[str, Any]) -> List[AttackPlan]:
        ...
        return [
            AttackPlan(
                ...
                steps=[PlanStep(step=1, action_type="initiate_payment", action="Amount spike",
            ...
            AttackPlan(
                ...
                steps=[PlanStep(step=1, action_type="initiate_payment", action="Velocity burst",
            ...
            AttackPlan(
                ...
                steps=[
                    PlanStep(step=1, action_type="link_beneficiary", action="Link beneficiary",
                             target_control="Beneficiary verification", payload_template={},
                             expected_outcome="PASS", rationale="New payee"),
                    PlanStep(step=2, action_type="initiate_payment", action="Pay new beneficiary",
